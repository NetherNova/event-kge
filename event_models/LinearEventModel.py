...
class ConcatenationFull(LinearEventModel):
    def __init__(self, num_entites, vocab_size, embedding_size, num_skips, shared=True, alpha=1.0):
        super(ConcatenationFull, self).__init__(num_entites, vocab_size, embedding_size, num_skips, shared, alpha)
...
class ConcatenationCause(LinearEventModel):
    def __init__(self, num_entites, vocab_size, embedding_size, num_skips, shared=True, alpha=1.0):
        super(ConcatenationCause, self).__init__(num_entites, vocab_size, embedding_size, num_skips, shared, alpha)
