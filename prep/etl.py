...
def update_amberg_ontology(ont, ent_dict, msg_dict, mod_dict, fe_dict, var_dict, data):
    ...
    for i, (msg, id) in enumerate(msg_dict.iteritems()):
        ...
        event_map = {'Maximum Stau': 'Max-Jam-Alarm',
                     ...
                     'Stau nach FE': 'FE-Jam',
                     'Stau nach  Drehstation': 'Stau nach  Drehstation',
                     ...
                     'Anlauf-Reset': 'Anlauf-Reset',
                     'Meister-WT': 'Meister-WT',
                     'Schieberstellung T?pfe': 'Schieberstellung T?pfe',
                     'Typkontrolle 1-polig': 'Typkontrolle 1-polig',
                     'Endlage Geh?useboden': 'Endlage Geh?useboden',
                     'IO-Kiste': 'IO-Kiste',
                     'Schieber NiO': 'Schieber NiO',
                     'Schieber nicht in Endlage': 'Schieber nicht in Endlage',
                     'Transportkiste': 'Transportkiste',
                     'WT h?ngt Vorstopper': 'WT h?ngt Vorstopper',
                     'Federnest': 'Federnest',
                     'Verpacker': 'Verpacker',
                     'Schlauchbeutel': 'Schlauchbeutel',
                     'Schutzt?re': 'Schutzt?re',
                     'Schutzthaube': 'Schutzthaube',
                     'WT h?ngt am Drehstopper': 'WT h?ngt am Drehstopper',
                     'WT h?ngt am Stopper': 'WT h?ngt am Stopper',
                     'Laufzeit ?berschritten': 'Laufzeit ?berschritten',
                     'WT h?ngt am ?bergang': 'WT h?ngt am ?bergang',
                     'Variantenwechsel': 'Variantenwechsel',
                     'Anwesenheit Br?cke': 'Anwesenheit Br?cke',
                     'Ultraschall': 'Ultraschall',
                     'Anforderung Meisterteil': 'Anforderung Meisterteil',
                     'Kraftanstieg': 'Kraftanstieg',
                     'Leerfahren': 'Leerfahren',
                     'Not-Halt': 'Not-Halt',
                     'Pneumatik-Hauptventil': 'Pneumatik-Hauptventil',
                     'WT ausheben': 'WT ausheben',
                     'Federkanal': 'Federkanal',
                     'SM_E 34': 'St?rung',
                     'Schl?sselschalter': 'Schl?sselschalter',
                     'Wegmeister-WT': 'Wegmeister-WT',
                     'Vereinzelner NO': 'Vereinzelner NO',
                     'Aufnahmepos Front': 'Aufnahmepos Front',
                     'Aufnahmepos F 2p': 'Aufnahmepos F 2p',
                     'Pick&Place': 'Pick&Place',
                     'Druckluftversorgung': 'Druckluftversorgung',
                     'Niederhalter': 'Niederhalter',
                     'Horizonalhub': 'Horizonalhub',
                     'Drehteller Deckelaufnahme': 'Drehteller Deckelaufnahme',
